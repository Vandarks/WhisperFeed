    ...
    return (
        <div className="flex grid grid-cols-2 place-content-stretch border">
            ...
            <div className="w-full flex flex-col items-center">
                ...
                <button className="w-2/6 rounded-2xl bg-green-500 bg-opacity-50 shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-green-500">Good</button>
                <button className="w-2/6 rounded-2xl bg-yellow-500 mb-2 mt-2 bg-opacity-95 shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-300">OK</button>
                <button className="w-2/6 rounded-2xl bg-red-600 bg-opacity-50 shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-red-500">Bad</button>
            </div>
            ...
            {messageClass ==="received" && (
                <div>
                    <form onSubmit={sendFeedback}>
                        <input value={formValue} placeholder="This course was..." onChange={(e) => setFormValue(e.target.value)} className="p-2"/>
                        <button type="submit" className="p-1 m-1 rounded-2xl bg-orange-500 px-3 bg-opacity-50 shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-green-500">Send Feedback</button>
                    </form>
                </div>
            )}
        </div>
